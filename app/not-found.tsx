...
export default function NotFound() {
  return (
    <section className="relative overflow-hidden">
      <div aria-hidden="true" className="accent-dot accent-dot-a absolute left-16 top-20 h-3 w-3 bg-green" />
      ...
      <div className="wrap relative flex flex-col items-center gap-10 py-24 text-center sm:py-32">
        ...
        <div>
          <p className="font-display text-8xl font-bold text-ink/15 sm:text-9xl">404</p>
          <SplitReveal
            as="h1"
            text="This page got lost in the algorithm."
            trigger="mount"
            className="mt-4 font-display text-3xl font-bold uppercase leading-tight tracking-tight text-ink sm:text-5xl"
          />
