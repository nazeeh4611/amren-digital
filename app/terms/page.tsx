  ...
  return (
    <>
      ...
      <article className="wrap max-w-3xl pb-24 pt-8 sm:pt-10">
        <h1 className="font-display text-4xl font-bold uppercase tracking-tight text-navy sm:text-5xl">Terms &amp; Conditions</h1>
        ...
        <div className="prose-amren mt-10 space-y-6 text-navy/75">
          <h2 className="font-display text-xl font-bold text-navy">Use of this website</h2>
          <p>
          ...
          <h2 className="font-display text-xl font-bold text-navy">Service engagements</h2>
          <p>
          ...
          <h2 className="font-display text-xl font-bold text-navy">No guaranteed results</h2>
          <p>
