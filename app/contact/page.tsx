    ...
    <>
      ...
      <section className="wrap grid gap-14 pb-24 pt-8 sm:pt-10 lg:grid-cols-[1fr_1fr] lg:gap-20">
        <div>
          ...
          <FadeIn delay={0.15} className="mt-10 space-y-5 text-navy/80">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wide text-navy/50">Location</p>
              <p className="mt-1">{site.location.label}</p>
            </div>
            <div>
              <p className="text-xs font-semibold uppercase tracking-wide text-navy/50">Phone / WhatsApp</p>
              <a href={site.contact.phoneHref} className="mt-1 block hover:text-blue">
                {site.contact.phone}
              </a>
            </div>
            <div>
              <p className="text-xs font-semibold uppercase tracking-wide text-navy/50">Website</p>
              <p className="mt-1">{site.contact.website}</p>
            </div>
            <div>
              <p className="text-xs font-semibold uppercase tracking-wide text-navy/50">Instagram</p>
